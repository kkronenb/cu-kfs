...
public class CuAutoDisapproveDocumentsServiceImplTest extends KualiTestBase {
    ...
    public final void testCheckIfRunDateParameterExists() {
        ...
        if (parameterService.parameterExists(AutoDisapproveDocumentsStep.class, KFSParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_DOCUMENT_STEP_RUN_DATE)) {
            try {
                // TODO : in service it is checking YEAR_END_AUTO_DISAPPROVE_DOCUMENT_CREATE_DATE ?
    ...
    public final void testCheckIfDocumentCompareCreateDateParameterExists() {
        ...
        // check to make sure the system parameter for create date check has already been setup...
    ...
    /*
     * TODO : this should work if YEAR_END_AUTO_DISAPPROVE_DOCUMENT_TYPES is updated to "FP".  If it is "FP;LD", then NPE
     */
