...
public class AccountGlobalRule extends GlobalDocumentRuleBase {
    ...
    /*
     * Check if the fund/subfund matched the income stream required parameters.
     * CU changed this to match the income stream requirement validation in 'AccountRule'.
     */
